...
";
        // line 26
        $context["classes"] = ((($context["classes"] ?? null)) ? (($context["classes"] ?? null)) : (["root" => "flex h-16 mr-8", "default" => ["a" => "flex px-3 py-2 w-full hover:bg-gray-100 dark:hover:bg-gray-900 items-center", "li" => ["base" => "flex leading-5 relative", "inactive" => (" " . $this->getAttribute(        // line 32
...
{% set classes = classes ? classes : {
  root: 'flex h-16 mr-8',
  default: {
    a: 'flex px-3 py-2 w-full hover:bg-gray-100 dark:hover:bg-gray-900 items-center',
    li: {
...
", "partials/navigation.html.twig", "C:\\wamp64\\www\\morganButton.dev\\user\\themes\\typhoon\\templates\\partials\\navigation.html.twig");
    }
}
